        ...
        <div className="flex flex-col items-center justify-center h-full">
          <div className="flex gap-12 items-center">
            <div className="text-center">
              ...
              <div className="w-[300px] h-[533px] bg-gray-100 border-2 border-gray-300 rounded-[40px] flex items-center justify-center relative overflow-hidden shadow-lg">
                <Video className="w-20 h-20 text-gray-400" />
                <div className="absolute bottom-8 left-8 right-8 bg-white rounded-lg p-4 shadow-md">
                  <p className="text-sm text-gray-700">Original TikTok Audio</p>
                </div>
              </div>
            </div>
            <ChevronRight className="w-16 h-16 text-pink-500" />
            <div className="text-center">
              <h3 className="text-3xl font-semibold mb-4 text-green-500">
                After
              </h3>
              <div className="w-[300px] h-[533px] bg-gradient-to-br from-pink-400 to-purple-500 rounded-[40px] flex items-center justify-center relative overflow-hidden shadow-lg">
          ...
          <div className="flex gap-12 items-center">
            <div className="text-center">
              ...
              <div className="w-[300px] h-[533px] bg-gray-100 border-2 border-gray-300 rounded-[40px] flex items-center justify-center relative overflow-hidden shadow-lg">
                <Video className="w-20 h-20 text-gray-400" />
                <div className="absolute bottom-8 left-8 right-8 bg-white rounded-lg p-4 shadow-md">
                  <p className="text-sm text-gray-700">Talking Comedy Clip</p>
                </div>
              </div>
            </div>
            <ChevronRight className="w-16 h-16 text-pink-500" />
            <div className="text-center">
              ...
              <div className="w-[300px] h-[533px] bg-gradient-to-br from-yellow-300 to-orange-400 rounded-[40px] flex items-center justify-center relative overflow-hidden shadow-lg">
                <Music className="w-20 h-20 text-white animate-bounce" />
              </div>
            </div>
          </div>
          ...
          <div className="flex gap-12 items-center">
            <div className="text-center">
              ...
              <div className="w-[300px] h-[533px] bg-gray-100 border-2 border-gray-300 rounded-[40px] flex items-center justify-center relative overflow-hidden shadow-lg">
                <Video className="w-20 h-20 text-gray-400" />
                <div className="absolute bottom-8 left-8 right-8 bg-white rounded-lg p-4 shadow-md">
                  <p className="text-sm text-gray-700">How-To Tutorial</p>
                </div>
              </div>
            </div>
            <ChevronRight className="w-16 h-16 text-pink-500" />
            <div className="text-center">
              ...
              <div className="w-[300px] h-[533px] bg-gradient-to-br from-blue-400 to-teal-300 rounded-[40px] flex items-center justify-center relative overflow-hidden shadow-lg">
                <Music className="w-20 h-20 text-white animate-bounce" />
                <div className="absolute bottom-8 left-8 right-8 bg-white rounded-lg p-4 shadow-md">
                  <p className="text-sm font-semibold text-gray-800">
                    EDM Tutorial Banger 🎧
